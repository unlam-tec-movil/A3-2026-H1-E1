...
class PopulateClinicsDbUseCaseTest {
    ...
    @Test
    fun `invoke saves clinics to repository`() = runTest {
        // Arrange
        val clinics = listOf(
            Clinic(
                id = 0,
    ...
    @Test
    fun `invoke handles empty clinics list`() = runTest {
        // Arrange
    ...
    @Test
    fun `invoke saves single clinic`() = runTest {
        // Arrange
        val clinic = Clinic(
            id = 5,
            name = "Test Clinic",
    ...
    @Test
    fun `invoke saves large clinics list`() = runTest {
        // Arrange
    ...
    @Test
    fun `invoke handles clinics with special characters`() = runTest {
        // Arrange
        val clinics = listOf(
            Clinic(
                id = 1,
    ...
    @Test
    fun `invoke can be called multiple times with different data`() = runTest {
        // Arrange
    ...
    @Test
    fun `invoke preserves data integrity during save`() = runTest {
        // Arrange
        val clinic = Clinic(
            id = 42,
